...
# Create Dataframe
Entity_Table = pd.read_sql('Select * from Entity_Table_3', cnx)
...
duplicates["Name_Address"] = duplicates.EntityName + " " + duplicates.Street_Name + " " + duplicates.City + " " + duplicates.StateName + " " + duplicates.Zip
